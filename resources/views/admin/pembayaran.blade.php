            ...
            <div class="modal-dialog modal-lg">
                <form action="/tambah_pembayaran" id="rooms-setting" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Metode</h5>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" min="1" name="no_rek" id="site_title_inp" class="form-control shadow-none">
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="form-label">Atas Nama</label>
                                <input type="text" min="1" name="an" id="site_title_inp" class="form-control shadow-none">
                            </div>
                        </div>
                    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="project-actions text-right">
                            <a class="btn btn-info btn-sm" href="/pembayaran/{{ $item->id }}/edit">
                                <i class="fas fa-pencil-alt"></i> Edit
                            </a>
                            <a class="btn btn-danger btn-sm" href="/pembayaran/{{ $item->id }}/delete" onclick="return confirm('Apakah yakin ingin menghapus?')">
