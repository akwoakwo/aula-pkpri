                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="nama" value="{{$user->nama}}" name="nama">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="alamat" value="{{$user->alamat}}" name="alamat">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="no_hp" value="{{$user->no_hp}}" name="no_hp">
                                </div>
                            </div>
                        </div>
                        <div class="row">
