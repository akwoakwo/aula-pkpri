                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="container d-flex flex-column">
                                                <a type="button" class="btn btn-warning mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Print invoice" href="{{ route('cetak_butki', ['id' => $item->id]) }}" target="_blank">
                                                ...
                                                <a type="button" class="btn btn-primary mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Lihat invoice" href="/invoice/{{ $item->id }}/">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                                        <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0"/>
                                                        <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7"/>
                                                    </svg>
                                                </a>
                                                <a type="button" class="btn btn-danger mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Batal pesan" href="/riwayat/{{ $item->id }}/delete" onclick="return confirm('Apakah yakin menghapus reservasi Anda?')">
