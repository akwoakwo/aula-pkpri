...
<body>
    ...
    <section class="container-fluid">
        <div class="container mx-auto mt-3 p-5 bg-white shadow-lg">
            ...
            <form action="{{ route('aula1') }}" method="GET" class="d-flex flex-wrap justify-content-between">
                @csrf
                <div class="col-md-4">
    ...
    <div class="container">
        <div class="row my-5">
            ...
            <div class="col-lg-3 mb-3 mb-lg-0">
                <a class="card card-efek p-3 mb-3 text-decoration-none" href="/informasi/{{ $item->id }}">
            ...
            <div class="col-lg-3 mb-3 mb-lg-0">
                <a class="card card-efek p-3 text-decoration-none" href="/informasi/{{ $item->id }}">
                    <img src="{{ asset('assets/img/aula1-1.jpg') }}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold">{{ $item->kategori }}</h5>
            ...
            <div class="col-lg-3 mb-3 mb-lg-0">
                <a class="card card-efek p-3 text-decoration-none" href="/informasi/{{ $item->id }}">
                    <img src="{{ asset('assets/img/aula1-2.jpg') }}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold">{{ $item->kategori }}</h5>
                        <p class="card-text m-0">{{ $item->nama_acara}}</p>
                        <p class="card-text m-0">{{ $item->kursi }}</p>
            ...
            <div class="col-lg-3 mb-3 mb-lg-0">
                <a class="card card-efek p-3 text-decoration-none" href="/informasi/{{ $item->id }}">
                    <img src="{{ asset('assets/img/aula1-4.jpg') }}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold">{{ $item->kategori }}</h5>
                        <p class="card-text m-0">{{ $item->nama_acara}}</p>
                        <p class="card-text m-0">{{ $item->kursi }}</p>
